...
export const CustomizeHomePage = () => {
  ...
  const removeOccasion = (index) => {
    setHomeData((prev) => ({
      ...
      occasions: {
        ...
        occasionImages: prev.occasions.occasionImages.filter(
          (_, i) => i !== index
        ),
      },
    }));
  ...
  return (
    <div className="p-6 h-screen w-[76rem] overflow-y-auto fixed">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Customize Home Page</h1>
        <button
                      ...
                      <div className="flex flex-col space-y-2">
                        <label className="cursor-pointer flex items-center justify-center px-3 py-2 border rounded-md text-xs bg-gray-100 hover:bg-gray-200">
                          ...
                          <input
                            ...
                            accept="image/*"
                            onChange={(e) =>
                              handleImageSelect("heroBanner", index, e)
                            }
                          />
                        </label>
                        <button
                          ...
                          disabled={
                            !imageUploads.heroBanner.files[index] ||
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateHeroBannerSlide(index, "titles", e.target.value)
                        }
        ...
        <section className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 italic">
              Note: Flash sale products are managed in the Products section with
              the "Flash Sale" tag.
            </p>
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex flex-col space-y-2">
                        <label className="cursor-pointer flex items-center justify-center px-3 py-2 border rounded-md text-xs bg-gray-100 hover:bg-gray-200">
                          ...
                          <input
                            ...
                            accept="image/*"
                            onChange={(e) =>
                              handleImageSelect("occasion", index, e)
                            }
                          />
                        </label>
                        <button
                          ...
                          disabled={
                            !imageUploads.occasion.files[index] ||
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={name}
                      onChange={(e) =>
                        updateOccasion(index, "name", e.target.value)
                      }
                      className="w-full px-3 py-2 border rounded-md"
                    ...
                    <div className="flex flex-col space-y-2">
                      <label className="cursor-pointer flex items-center justify-center px-3 py-2 border rounded-md text-xs bg-gray-100 hover:bg-gray-200">
                        ...
                        <input
                          ...
                          accept="image/*"
                          onChange={(e) =>
                            handleImageSelect("advert", index, e)
                          }
                        />
                      </label>
                      <button
                        ...
                        disabled={
                          !imageUploads.advert.files[index] ||
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateCustomSection(index, "category", e.target.value)
                      }
                      className="w-full px-3 py-2 border rounded-md"
                      placeholder="Category name (e.g., Birthday, Valentines)"
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Products with this category will be displayed in this
                      section
                    </p>
                  </div>
